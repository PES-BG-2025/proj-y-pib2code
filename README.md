...
Este proyecto consiste en el diseño e implementación de un algoritmo en Python para calcular el encadenamiento trimestral del Producto Interno Bruto (PIB) de Guatemala, desagregado por sectores económicos (primario, secundario y terciario). A partir de datos de series a precios corrientes y constantes, el programa aplica la fórmula de encadenamiento trimestral para obtener un PIB encadenado que permite realizar comparaciones más precisas entre períodos. Además, se desarrolla un dashboard interactivo en Streamlit, con un diseño dinámico de gráficas que facilita la visualización de los resultados, permitiendo explorar de manera intuitiva la evolución del PIB y de cada sector económico. Con ello, se busca mostrar cómo una técnica utilizada en la contabilidad nacional puede automatizarse y enriquecerse con herramientas de programación y visualización de datos.
